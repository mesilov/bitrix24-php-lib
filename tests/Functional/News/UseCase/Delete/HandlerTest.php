...
namespace Bitrix24\Lib\Tests\Functional\News\UseCase\Delete;

use Bitrix24\Lib\News\Exceptions\NewsNotFoundException;
use Bitrix24\Lib\News\Infrastructure\Doctrine\NewsRepository;
use Bitrix24\Lib\News\UseCase\Delete\Command;
use Bitrix24\Lib\News\UseCase\Delete\Handler;
...
class HandlerTest extends TestCase
{
    ...
    public function testCanDeleteNews(): void
    {
        ...
        $this->repository->getById($news->getId());
    }
